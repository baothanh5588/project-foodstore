                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="header">
 	                           ...
 	                           <div class="content">
                                <form  id="add_user" action="${pageContext.request.contextPath}/admin/product/add"  method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Tên sản phẩm</label>
                                                <input value="" type="text" name="name_sp" class="form-control border-input" placeholder="" >
                                            </div>
                                        </div>
                                    </div>               
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input value="" type="text" name="price" class="form-control border-input" placeholder="" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input value="" type="text" name="thongtin_sp" class="form-control border-input" placeholder="" >
                                            </div>
                                        </div>
                                    </div>                                                                        
